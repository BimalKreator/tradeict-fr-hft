...
const navItems = [
  ...
  { href: "/logs", label: "Trade Logs", icon: TradeLogsIcon },
  { href: "/settings", label: "Settings", icon: SettingsIcon },
  { href: "/exchange-setup", label: "Exchange Setup", icon: ExchangeSetupIcon },
];
...
function TradeLogsIcon({ active }: { active?: boolean }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
function ExchangeSetupIcon({ active }: { active?: boolean }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
